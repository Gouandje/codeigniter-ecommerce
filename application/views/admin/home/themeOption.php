...
<div id="content" class="span10 padtop">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <i class="icon-edit"></i>
            <a href="<?php echo base_url('index.php/admin/themeOption')?>">Ajouter une Option Theme </a>
        </li>
    </ul>
        ...
        <div class="box span12">
         ...
         <?php endif; ?>
            <div class="box-content">
                <form class="form-horizontal" action="<?php echo base_url('index.php/admin/save_option')?>" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <img src="<?php echo base_url('assets/uploads/');?><?php echo get_option('site_logo');?>" style="width:300px;height:200px"/>
                            </div>
                        </div> 
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <img src="<?php echo base_url('assets/uploads/');?><?php echo get_option('site_favicon');?>" style="width:300px;height:200px"/>
                            </div>
                        </div>
