        ...
        <div class="box span12">
            ...
            <div class="box-content">
                <div class="span4 text-left">
                    <h2>Customer Info(CIBR0000<?php echo $customer_info->customer_id; ?>)</h2>
                ...
                <div class="span4 text-right" class="table table-striped table-bordered">
                    <h2>Customer Info(CIBR0000<?php echo $shipping_info->shipping_id; ?>)</h2>
                    <table class="table table-striped table-bordered">
                        <tr>
                            <td>Shpping Name : </td>
                    ...
                    <tbody>
                        ...
                        foreach ($order_details_info as $single_order_details) {
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo base_url('assets/produits/'.$single_order_details->product_image);?>" style="width:200px;height:100px"/></td>
                                ...
                                <td><?php echo $this->cart->format_number($single_order_details->product_price * $single_order_details->product_sales_quantity) ?> F CFA</td>
                            </tr>
                        <?php } ?>
                    </tbody>
                    <tfooter>
